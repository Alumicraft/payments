...
def handle_stripe_webhook():
    ...
    Endpoint: /api/method/stripe_integration.webhook.handle_stripe_webhook
    """
    from stripe_integration.stripe_integration.stripe_integration import get_gateway_controller
    from stripe_integration.stripe_integration.doctype.stripe_webhook_event.stripe_webhook_event import (
